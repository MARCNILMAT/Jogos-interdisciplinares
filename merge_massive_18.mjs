...
function getNextId() {
    ...
    if (!matches) return 2645;
    const ids = matches.map(m => parseInt(m.match(/\d+/)[0]));
    return Math.max(...ids) + 1;
}

const startId = getNextId();
console.log(`Lote Massive 18 (Inglês, Religioso e EdFisica) a partir do ID: ${startId}`);
...
const batch = [
  ...
  { grade: "7º", discipline: "Inglês", type: "multiple", text: "The pronoun for a girl is:", options: ["He", "She", "It", "They"], answer: "She", explanation: "She = Ela.", skill: "Pronouns" },
  { grade: "8º", discipline: "Inglês", type: "multiple", text: "What is the past tense of the verb 'to go'?", options: ["Goes", "Going", "Went", "Gone"], answer: "Went", explanation: "Went é o passado irregular de go.", skill: "Simple Past" },
  { grade: "9º", discipline: "Inglês", type: "multiple", text: "Choose the correct comparative: 'The elephant is ___ than the cat.'", options: ["Big", "Bigger", "Biggest", "More big"], answer: "Bigger", explanation: "Adjetivos curtos recebem -er no comparativo.", skill: "Comparatives" },

  // --- ENSINO RELIGIOSO (6º ao 9º Ano) ---
  { grade: "6º", discipline: "Ensino Religioso", type: "multiple", text: "Qual destes é um símbolo universal da paz?", options: ["Uma caveira", "Uma pomba branca", "Um raio", "Uma espada"], answer: "Uma pomba branca", explanation: "A pomba com um ramo de oliveira simboliza a paz.", skill: "Símbolos" },
  ...
  { grade: "7º", discipline: "Educação Física", type: "multiple", text: "Quantos jogadores compõem uma equipe de Voleibol em quadra?", options: ["5", "6", "11", "7"], answer: "6", explanation: "Cada time joga com 6 atletas titulares.", skill: "Voleibol" },
